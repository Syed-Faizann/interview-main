...
export default function GoalTabs() {
  ...
  const tabs = ["All", "Individual Goal", "Milestone Goal"];
  ...
  return (
    <div
      ref={containerRef}
      className="relative inline-flex items-center bg-[#3D3148] rounded-full p-1"
    >
      {/* Animated sliding background */}
      <div
        className="absolute top-0 left-0 h-[calc(100%-0.25rem)] bg-[#E04C6B] rounded-full transition-all duration-300"
