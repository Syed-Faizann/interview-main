...
export default function StatusDropdown() {
  ...
  return (
    <div className="relative inline-block text-left" ref={ref}>
      ...
      >
        {status}
        <span className={`text-xs transition-transform duration-300 ${open ? "rotate-90" : ""}`}>›</span>
      </button>

      {/* Dropdown that stays on screen */}
      <div
        className={`absolute mt-2 rounded-xl bg-white text-black
